        ...
        for buffer_semantic in proxy_layout.semantics:
            ...
            if semantic == Semantic.VertexId:
                ...
                if hasattr(mesh, 'vertex_colors') and semantic_name in mesh.vertex_colors:
                    # Legacy projects support (for object imported with EFMI Tools 1.3.5 or below)
    ...
    def get_vertex_data(self, 
        ...
        for buffer_semantic in proxy_layout.semantics:
            ...
            if semantic == Semantic.Position:
                ...
                data = self.fetch_data(mesh.attributes[semantic_name].data, 'color', numpy_type, size)
            else:
                continue
